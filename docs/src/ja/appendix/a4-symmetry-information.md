<!-- 260605Cl: ReciPro の docs/src/ja/2-symmetry-information.md を IPAnalyzer 付録へ移植（リード言語: 日本語）。対称性情報ウィンドウは ReciPro と共通の Crystallography.Controls コンポーネント。 -->

# Appendix A4. 対称性情報 (Symmetry Information)
...
IPAnalyzer では、パラメータ校正で用いる標準結晶を定義する **Crystal ウィンドウ**（[4. 実際の手順](../4-procedures.md) の幾何学的校正や [6. パラメータ校正（力ずく）](../6-find-parameter.md) で開く CrystalControl）の中から、このサブウィンドウを開けます。
...
- [付録トップ](index.md)
- [4. 実際の手順](../4-procedures.md) — 標準結晶を用いた幾何学的パラメータ校正。
- [6. パラメータ校正（力ずく）](../6-find-parameter.md)
