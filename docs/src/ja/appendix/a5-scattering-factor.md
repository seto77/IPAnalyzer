<!-- 260605Cl: ReciPro の docs/src/ja/3-scattering-factor.md を IPAnalyzer 付録へ移植（リード言語: 日本語）。散乱因子ウィンドウは ReciPro と共通の Crystallography.Controls コンポーネント。 -->
...
- [付録トップ](index.md)
- [4. 実際の手順](../4-procedures.md) — 構造因子の計算対象となる標準結晶の定義。
