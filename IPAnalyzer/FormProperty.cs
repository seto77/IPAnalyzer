...
public partial class FormProperty : Form
{
    ...
    # region TabControl1のDrawItemイベントハンドラ
    ...
    #region comboBoxRectangleDirectionが変更された時のイベント
    ...
    bool IsSkipNumericUpDownInIntensity = false;

    #region radioButtonAngleModeが変更されたときのイベント
    ...
    private void checkBoxMaskEdge_CheckedChanged_1(object sender, EventArgs e) => formMain.IntegralArea_Changed(sender, e);
    ...
    {
        if (IsSkipNumericUpDownInIntensity) return;
    ...
    private void textBoxPixelSizeX_TextChanged(object sender, EventArgs e) => formMain.Draw();

    private void numericUpDownManualSpotSize_ValueChanged(object sender, EventArgs e)
    {
    ...
    private void checkBoxRectangleIsBothSide_CheckedChanged(object sender, EventArgs e) => formMain.IntegralArea_Changed(sender, e);
    ...
    private void buttonSaveMask_Click(object sender, EventArgs e) => formMain.toolStripMenuItemSaveMask_Click(sender, e);
    ...
    private void checkBoxCorrectPolarization_CheckedChanged(object sender, EventArgs e) => formMain.FlipRotate_Pollalization_Background();
    ...
    private void colorControlScale2Theta_Load(object sender, EventArgs e) => formMain.Draw();
