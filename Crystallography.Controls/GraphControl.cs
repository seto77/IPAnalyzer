   ...
   // [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    public string MousePositionX_FormatSpecifier // 260608Cl 追加
    {
        ...
        set
        {
            ...
            mousePositionX_FormatSpecifierValid = isValidFormatSpecifier(mousePositionX_FormatSpecifier); // 有効性を判定してキャッシュ
        }
    }
    ...
    public string MousePositionY_FormatSpecifier // 260608Cl 追加
    {
        ...
        set
        {
            ...
            mousePositionY_FormatSpecifierValid = isValidFormatSpecifier(mousePositionY_FormatSpecifier); // 有効性を判定してキャッシュ
        }
    }
    private string mousePositionY_FormatSpecifier = ""; // 260608Cl 追加
    private bool mousePositionY_FormatSpecifierValid = false; // 260608Cl 追加

    // 260608Cl 追加: 書式文字列が double.ToString で例外を投げないか判定する (NumericBox.FormatSpecifier と同ロジック)。
    // 空文字は「桁数指定 (MousePosition*Digit) を使う」ことを意味するので無効扱い (false) とする。
